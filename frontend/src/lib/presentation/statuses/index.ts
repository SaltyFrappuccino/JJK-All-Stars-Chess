...
const statusDescriptions: Record<string, string> = {
  ...
  burn: "Если фигура не уйдёт с лавы, она погибнет.",
  silence: "Фигура не может использовать технику или РТ.",
  paralysis: "Фигура не может двигаться и использовать техники.",
  domination: "Фигура временно подчинена и не может действовать.",
  mass_pressure: "Фигура не может использовать технику или РТ на следующий ход.",
  marked: "При взятии этой фигуры владелец атакующего получит дополнительную энергию.",
